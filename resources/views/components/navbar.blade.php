    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="shrink-0">
                    <img class="size-8" src="img\AdminLTELogo.png" alt="My Company">
                </div>
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->

                        {{-- Alt 1: <x-nav-link></x-nav-link> --}}
                        {{-- Alt 2: <x-nav-link href="/"></x-nav-link> --}}
                        <x-nav-link href="/" :active="request()->is('/')">Home</x-nav-link>
                        <x-nav-link href="/team" :active="request()->is('team')">Team</x-nav-link>
                        <x-nav-link href="/pages" :active="request()->is('pages')">Pages</x-nav-link>
                        <x-nav-link href="/blog" :active="request()->is('blog')">Blog</x-nav-link>
                        {{-- <x-nav-link href="/about" :active="request()->is('about')">About</x-nav-link> --}}
                        <x-nav-link href="/cal" :active="request()->is('cal')">Calender</x-nav-link>

                        {{-- membuat nav link menjadi dinamis dan ressponsive --}}
                        {{-- <a href="/blog"
                        ...
                        {{-- <a href="/calender" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Calender</a> --}}
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
